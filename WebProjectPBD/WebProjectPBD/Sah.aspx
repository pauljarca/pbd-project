<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sah.aspx.cs" Inherits="WebProjectPBD.Sah" %>
            ...
            <div class="card-body">
               ...
               <p class="card-text">
                ...
                <p class="card-text">
                    ...
                    <asp:Button ID="CautaJucator2_btn" runat="server"  class="btn btn-secondary" Text="Cautare jucator" OnClick="CautaJucator2_btn_Click" />
                </p>
                <p class="card-text">
